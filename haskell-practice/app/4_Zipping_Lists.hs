-- In Haskell, zipping is a way of combining two lists into a list of pairs (tuples). 
-- The zip function takes two lists as inputs and combines corresponding elements from each list into pairs. 
-- The result is a list of tuples, with each tuple containing one element from each of the input lists at the same position.
